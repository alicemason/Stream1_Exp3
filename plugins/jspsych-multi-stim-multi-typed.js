...
jsPsych.plugins["multi-stim-multi-typed"] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('multi-stim-multi-typed', 'stimuli', 'image');
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // optional parameters
    trial.nResponses = (typeof trial.is_html === 'undefined') ? trial.stimuli.length : trial.nResponses;
    ...
    function showNextStimulus() {
      ...
      if (!trial.is_html) {
        display_element.append($('<img>', {
          ...
          id: 'jspsych-multi-stim-multi-typed-stimulus'
        }));
      } else {
      ...
      if (typeof trial.timing_stim[whichStimulus] !== 'undefined' && trial.timing_stim[whichStimulus] > 0) {
        var t1 = setTimeout(function() {
          ...
          if (typeof trial.stimuli[whichStimulus + 1] !== 'undefined') {
            ...
            $('#jspsych-multi-stim-multi-typed-stimulus').css('visibility', 'hidden');
          }
